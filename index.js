...
// Middleware
    ...
    /*  
        Remember the token formate: bearer token (example: bearer fldjfljdfljfflwoufy)
        *But we need only the token code. 
        *So we have to split the token with an empty space and have to take second indexed value;
     */
